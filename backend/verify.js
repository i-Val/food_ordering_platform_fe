...
console.log('Starting verification test for Choply API...');
...
// Helper to send HTTP requests using Node http module
function request(method, path, body = null, token = null) {
  return new Promise((resolve, reject) => {
    const options = {
      hostname: '127.0.0.1', // Use explicit IPv4 to avoid localhost resolution ambiguities
      port: 3005,
      path: path,
      method: method,
      headers: {
